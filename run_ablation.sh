...
export CUDA_VISIBLE_DEVICES="0,1,2,3" # specific devices to use on this node
export NODE_RANK=0 # the node running this script will be master node (rank 0)

# Training config
CONFIG_FILE="./dinov2/configs/train/vitg14_reg4_ablations.yaml"
OUTPUT_DIR="./output_ablation_baseline_bs12"
